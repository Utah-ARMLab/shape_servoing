...
def retrieve_cfg(args, use_rlg_config=False):
    if use_rlg_config:
        ...
        elif args.task == "ShapeServo":
            return os.path.join(args.logdir, "shape_servo"), "cfg/train/rlg/rlg_franka_cabinet.yaml", "cfg/shape_servo.yaml"
        ...
        if args.task == "BallBalance":
            ...
            return os.path.join(args.logdir, "shape_servo"), "cfg/train/rlpt/pytorch_ppo_franka_cabinet.yaml", "cfg/shape_servo.yaml"
        elif args.task == "ShapeServoHER":
            return os.path.join(args.logdir, "shape_servo_her"), "cfg/train/rlpt/pytorch_ppo_franka_cabinet.yaml", "cfg/shape_servo.yaml"
