...
import sys
sys.path.append("/home/baothach/dvrk_shape_servo/src/dvrk_env/dvrk_gazebo_control/src/rlgpu/rl-pytorch/rl_pytorch")
import inspect
from ppo import PPO, PPO2, ActorCritic, DeformerNetActorCritic

def process_ppo(args, env, cfg_train, logdir, ppo_version=1):
    # import rl_pytorch
    # print("==========",rl_pytorch.__file__)
    # print("==========",inspect.getmodule(ActorCritic).__file__)
    ...
    if ppo_version == 1:
        ppo = PPO(vec_env=env,
                actor_critic_class=DeformerNetActorCritic,
