...
#                     filter_data(result_dir, prim_name, f"{prim_name}_{obj_type}", inside=True, range_data=range_data))
#             else:
#                 outside_data[prim_name].append(
#                     filter_data(result_dir, prim_name, f"{prim_name}_{obj_type}", inside=False, range_data=range_data))
