...
if __name__ == "__main__":
    ...
    args = gymutil.parse_arguments(
        description="dvrk",
        custom_parameters=[
            {"name": "--obj_name", "type": str, "default": 'hemis_0', "help": "select variations of a primitive shape"},
    ...
    asset_root = "/home/baothach/sim_data/Custom/Custom_urdf/multi_hemis_1000Pa"
    soft_asset_file = args.obj_name + ".urdf"    
    soft_pose = gymapi.Transform()
    soft_pose.p = gymapi.Vec3(0, 0.4-0.86, -o/2.)
    ...
    data_recording_path = "/home/baothach/shape_servo_data/generalization/multi_hemis_1000Pa/data"
    terminate_count = 0
    sample_count = 0
    frame_count = 0
    group_count = 0
    data_point_count = len(os.listdir(data_recording_path))
    max_group_count = 3000
    max_sample_count = 10
    max_data_point_count = 30000
    # if args.obj_name == 'box_64':
    #     max_data_point_per_variation = 9600
    # else:
    max_data_point_per_variation = data_point_count + 300
    ...
    while (not close_viewer) and (not all_done): 
        ...
        if state == "home" :   
            ...
            if frame_count == 10:
                ...
                current_particle_state = get_particle_state()
        ...
        if state == "move to goal":
            ...
            if not(9 in contacts or 10 in contacts):  
                ...
                if frame_count % 15 == 0:
                    ...
                    recorded_particle_states.append(get_particle_state)
                ...
                if traj_index == len(plan_traj):
                    ...
                    particle_state_goal = get_particle_state()
