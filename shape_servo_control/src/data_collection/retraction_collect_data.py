...
if __name__ == "__main__":
    ...
    soft_pose.p = gymapi.Vec3(0.035, 0.40-0.86, 0.01)  # 0.08
    ...
    max_sample_count = 10
    max_data_point_count = 6000    
    dc_client = GraspClient()
    data_recording_path = "/home/baothach/shape_servo_data/generalization/surgical_setup/data_on_ground_2"
